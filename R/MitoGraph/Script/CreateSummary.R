# Assumes Data (gnets) are in a folder called Data/ in the wd. Outputs go into Output/Data/
...
Output <- paste0("Output/Data/output.csv")
OutputSummary <- paste0("Output/Data/output-summary.csv")
